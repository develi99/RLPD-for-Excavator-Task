...
# Reward 5
# XLA_PYTHON_CLIENT_PREALLOCATE=false uv run train_finetuning_pixels_excuvator.py --memory_efficient_replay_buffer True --utd_ratio=2 --start_training 5000 --max_steps 800000 --config.backup_entropy=False --config.num_min_qs=2 --config.num_qs=2 --log_dir /home/elias/Masterstudium/DeepLearningRobotics/rlpd/logs/pixel/run4/checkpoints --name Reward5 --agxreward 5 --image_size 100 --seed 0 --num_stack 1

XLA_PYTHON_CLIENT_PREALLOCATE=false uv run train_finetuning_pixels_excuvator.py --memory_efficient_replay_buffer True --utd_ratio=2 --start_training 5000 --max_steps 800000 --config.backup_entropy=False --config.num_min_qs=2 --config.num_qs=2 --log_dir /home/elias/Masterstudium/DeepLearningRobotics/rlpd/logs/pixel/run5/checkpoints --name Reward5 --agxreward 5 --image_size 100 --seed 1 --num_stack 1

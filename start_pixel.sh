XLA_PYTHON_CLIENT_PREALLOCATE=false uv run -m pdb train_finetuning_pixels_excuvator.py --memory_efficient_replay_buffer True --utd_ratio=2 --start_training 5000 --max_steps 800000 --config.backup_entropy=False --config.num_min_qs=2  --config.num_qs=2 --log_dir /home/elias/Masterstudium/DeepLearningRobotics/rlpd/logs/pixel/run1/checkpoints --name Reward3 --agxreward 3 --image_size 128 --seed 0
